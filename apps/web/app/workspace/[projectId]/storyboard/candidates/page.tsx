...
import { IllustrationContactSheetView } from "./contact-sheet-view";
...
export default async function IllustrationCandidatesPage({
  params,
}: {
  ...
  return (
    <AuthenticatedAppShell
      ...
      maxWidth="1200px"
    >
      <IllustrationContactSheetView projectId={projectId} />
    </AuthenticatedAppShell>
  );
}
