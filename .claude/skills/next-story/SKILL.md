---
name: next-story
description: Find the next eligible implementation story in the AI Visual Learning Platform story pack, then plan and implement it in dependency order per the repository workflow. Use when asked to continue the story plan, start the next story, determine the next unblocked story, or implement the work after the last completed story.
---
