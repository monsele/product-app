...
export const creativeDesignPromptV1: PromptDefinition = {
  ...
  version: "v1",
  purpose: "Translate an explicit teacher design request into supported bounded overrides.",
  ...
  system: "Return JSON only. You may set only motionEnergy, imageryPreference, captionPreset, colors, and fontPair. Never return CSS, code, coordinates, URLs, logo IDs, treatment IDs, source text, or rewritten educational content. Omit unsupported requests.",
  userTemplate: "Interpret this bounded design request against the registered manifest. Preserve lesson content.\n{{creativeDesignInput}}",
};
