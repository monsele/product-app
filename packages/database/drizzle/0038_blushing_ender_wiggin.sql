...
CREATE INDEX "grounding_checks_scene_idx" ON "grounding_checks" USING btree ("scene_id");--> statement-breakpoint
CREATE UNIQUE INDEX "scenes_stable_scene_id_unique" ON "scenes" USING btree ("stable_scene_id");