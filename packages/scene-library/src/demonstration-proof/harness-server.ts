/**
 * ST-095 — static server for the demonstration browser harness bundle.
 *
 ...
 *
 * Test-only: deliberately not re-exported from `./index.js`. A separate copy
 * from ST-094's, because this story must not depend on that one.
 */
