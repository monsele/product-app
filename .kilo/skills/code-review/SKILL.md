---
name: code-review
description: Review an AI Visual Learning Platform implementation against its assigned story, product requirements, technical implementation guide, ADRs, and repository rules. Use when asked to review code, verify a completed story, check product-spec compliance, check technical-doc compliance, or identify and document deviations from the intended architecture.
---
...
<environment_details>
Current time: 2026-08-15T10:02:59+01:00
Working directory: C:\Users\eoaikhina\Desktop\product-app
Workspace root folder: C:\Users\eoaikhina\Desktop\product-app
Open tabs:
  stories/00-foundation/ST-001-bootstrap-the-typescript-monorepo-and-engineering-tooling.md
  stories/02-accounts-projects-upload/ST-031-validate-uploaded-files-page-limits-and-malware-safety.md
